...
export default function Page() {
  ...
  const SendMessage = async (e: { preventDefault: () => void }) => {
    ...
    if (form.message.length <= 20)
      return toast.error("Type More than 20 letter", {
        description: "add more details to your message",
      });
    ...
    try {
      ...
      if (!session) {
        return toast.error("Failed to send message, try again");
      }
      ...
      return toast.success("Message Send Successfully", {
        description: "Contact support will message you as soon as possible",
